                    ...
                    <div>
                        <a href="/" class="py-2 md:py-0">
                            <div class="flex items-center">
                                <span
                                    class="font-bold text-gray-800 text-lg md:text-xl ml-2">Money Keep</span>
                            </div>
                        </a>
                    </div>
                    <div>
            ...
            @component('components.card')
                ...
                <div x-data="login()">
                    ...
                    'classes' => "mb-6 text-center"
                        ...
                        Пожалуйста введите свою почту и пароль что бы продолжить
                    @endcomponent
                    <form method="POST" x-on:submit.prevent="attemptLogin()" id="form1">
                        ...
                        <div class="mb-4">
                            <label for="password"
                                   class="form-label block mb-2 font-semibold text-gray-700">Пароль</label>
                            <div class="relative">
                        ...
                        <button type="submit" name="submitButton"
                                ...
                                class="mt-4 text-white text-normal px-6 py-3 w-full bg-blue-500 hover:bg-blue-600 rounded-lg">
                            Вход
                        </button>
