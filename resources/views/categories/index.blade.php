...
@section('content')
    <div class="px-4 py-6">
        <div class="md:max-w-5xl md:mx-auto">
            <div x-data="{ categoryCreateModal: false, categoryName: '', errors: [], loading: false,categoryImg:'' }" x-cloak>
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div>
                        <a href="#" x-on:click.prevent="categoryCreateModal = true"
                           class="inline-block px-6 py-3 rounded-lg text-white bg-blue-500 hover:bg-blue-600">Новая
                            категория</a>
                    </div>
                </div>
					...
					">
                            ...
                            'withFooter' => true
                                ...
                                'size' => 'heading'
                                    ...
                                    Coздайте новую категорию
                                @endcomponent

                                <div class="mb-4 mt-2">
                                    <label for="name" class="form-label block mb-2 font-semibold text-gray-700">Название
                                        категории</label>
                                    <div class="relative">
                                        <input type="text" name="name" x-model="categoryName"
                                            ...
                                            Картинки:<br />
                                            <input name="userfile" id="image"  type="file" x-model="categoryImg" multiple="true"
...
{{--                                                            // reader.readAsDataURL(file);--}}
                                ">
                                        ...
                                        <div x-show="errors['name']" x-cloak>
                                            <svg class="absolute text-red-600 fill-current"
                                ...
                                @slot('footer')
                                    <div class="text-right">
                                        <button type="button"
                                                x-on:click="categoryCreateModal = false; categoryName = ''"
