			...
			deleteCategoryButton.classList.add('base-spinner');">
                ...
                'withFooter' => true
                    ...
                    'size' => 'large'
                        ...
                        Вы уверерны что хотите удалить категорю?
                    @endcomponent
                    <p>Запись удалится безвозвратно ,если вы удалите!</p>
                    <div class="border rounded-lg mt-4">
                        <div class="flex py-2 px-4">
                            <div class="mr-2">Название категории:</div>
        ...
        <div class="p-4 max-w-xl mx-auto absolute left-0 right-0 overflow-hidden mt-24">
			...
			">
                ...
                'withFooter' => true
                    ...
                    <div class="mb-4 mt-2">
                        <label for="name" class="form-label block mb-2 font-semibold text-gray-700">Название категории</label>
                        <div class="relative">
    ...
    @if ($categories->isEmpty())
        @component('components.card')
            <div class="py-10 text-center">
                <p class="mb-6">Категории не найдены <br> Нажмите кнопку ниже, чтобы добавить новую категорию.</p>
    ...
    @else
        <div class="shadow rounded-lg overflow-hidden mb-8">
            <table class="w-full whitespace-no-wrap bg-white overflow-hidden">
                ...
                @foreach($data as $img)
                    <td>{{$img->id}}</td>
                        <td> <?php foreach (json_decode($img->filename)as $picture) { ?>
                            <img src="{{ ('../category/'.$picture) }}" style="height:120px; width:200px"/>
                            <?php } ?>
                        </td>
                @endforeach
                        </td>
