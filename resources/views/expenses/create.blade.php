            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full md:w-1/3 px-4">
                    ...
                    'classes' => "mb-2"
                        ...
                        Добавьте ваши расходы
                    @endcomponent
                    @component('components.heading', [
                    'classes' => "mb-6"
                    ])
                        Введите свои обычные расходы для их отслеживания
                    @endcomponent
                </div>
                <div class="w-full md:w-2/3 px-4">
                    @component('components.card')
                        <form method="POST" x-on:submit.prevent="saveExpense()">
                            @csrf
                            <div class="mb-4">
                                <label for="category" class="form-label block mb-2 font-semibold text-gray-700">Категории
                                    расходов</label>
                                <div class="relative">
                                    ...
                                    <div x-show="errors['category']" x-cloak>
                                        ...
                                        <span class="text-red-600 mt-1 text-sm block"
                                              x-text="errors['category']"></span>
                                    </div>
                                </div>
                                @component('components.heading', [
                                'classes' => "mt-2"
                            ...
                            <div class="mb-4">
                                <label for="expense_name" class="form-label block mb-2 font-semibold text-gray-700">Название</label>
                                <div class="relative">
                                    <input type="text" name="expense_name" x-model="expenseName"
                                           placeholder="Movie with friends :)"
                                           x-on:keydown="delete errors['expense_name']"
                                    ...
                                    <div x-show="errors['expense_name']" x-cloak>
                                        ...
                                        <span class="text-red-600 mt-1 text-sm block"
                                              x-text="errors['expense_name']"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-4">
                                <label for="expense_amount" class="form-label block mb-2 font-semibold text-gray-700">Сумма
                                    расходов</label>
                                <div class="relative w-32">
                                    ...
                                    <svg x-show="errors['expense_amount']" x-cloak
                                         class="absolute text-red-600 fill-current"
                                         style="top: 12px; right: 12px" xmlns="http://www.w3.org/2000/svg" width="24"
                                         height="24"
                                         viewBox="0 0 24 24">
                                        <path
                                            d="M11.953,2C6.465,2,2,6.486,2,12s4.486,10,10,10s10-4.486,10-10S17.493,2,11.953,2z M13,17h-2v-2h2V17z M13,13h-2V7h2V13z"/>
                                ...
                                <div x-show="errors['expense_amount']" x-cloak>
                                    <span class="text-red-600 mt-1 text-sm block"
                                          x-text="errors['expense_amount']"></span>
                                </div>
                            </div>
                            <div class="mb-4">
                                <label for="datepicker" class="form-label block mb-2 font-semibold text-gray-700">Дата
                                    расходов</label>
                                <div class="relative w-64">
                                    ...
                                    <svg class="absolute text-gray-400 fill-current" width="20" height="20"
                                         style="top: 14px; left: 12px" xmlns="http://www.w3.org/2000/svg"
                                         viewBox="0 0 20 20">
                                        <path
                            ...
                            <div class="mb-4">
                                <label for="expense_details" class="form-label block mb-2 font-semibold text-gray-700">Детали
                                    расходов(не обязательно)</label>
                                <div class="relative">
							<textarea name="expense_details" id="expense_details" x-model="expenseDetails"
                                    ...
                                    <div x-show="errors['expense_details']" x-cloak>
                                        ...
                                        <span class="text-red-600 mt-1 text-sm block"
                                              x-text="errors['expense_details']"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-6">
                                <a href="#"
                                   class="mr-2 bg-white shadow text-gray-600 text-normal font-semibold px-6 py-3 hover:shadow-md rounded-lg inline-block">Отменить</a>
                                <button type="submit" name="submitButton"
                                        x-bind:class="{ 'cursor-not-allowed opacity-25 base-spinner': loading == true }"
                                        x-bind:disabled="loading == true"
                                        class="shadow text-white  text-normal font-semibold px-6 py-3 bg-blue-500 hover:bg-blue-600 rounded-lg">
                                    Сохранить запись
                                </button>
                            </div>
                        </form>
    ...
    <script data-turbolinks-track="reload">
        ...
        function expense() {
            return {
                ...
                expenseDetails: '',
                expenseAmount: 0,
                category: @json($categories[0]->id),
                errors: [],
                saveExpense() {
                    window.axios.post('/expenses', {
