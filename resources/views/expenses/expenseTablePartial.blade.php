			...
			deleteExpenseButton.classList.add('base-spinner');">
				...
				<div class="text-right">
					<button type="button" x-on:click="showModal = false"
						class="px-4 py-2 rounded-lg text-gray-600 bg-white hover:text-blue-600 shadow mr-2">Отменить</button>
					<button type="submit" name="deleteExpenseButton"
						class="px-4 py-2 rounded-lg text-white bg-red-500 hover:bg-red-600 shadow">Подтвердить</button>
				</div>
				@endslot
				@endcomponent
			</form>
