...
@section('content')
    <div class="px-4 py-6">
                        ...
                        @component('components.card')
                            <div class="flex flex-wrap items-center md:block md:mt-5">
                                <div
                                    ...
                                    <div class="mb-8 md:mb-12 absolute left-0 right-0 mx-auto bottom-0"
                                         style="z-index: 1">
                                        <div
                                            class="bg-blue-600 mx-auto rounded-lg relative w-20 py-2 border-2 border-blue-100">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="h-2 w-2 rounded-full bg-blue-600 border-2 border-blue-100"></div>
                                            </div>

                                            <div
                                                class="w-8 h-8 bg-orange-500 border-4 border-blue-100 rounded-full -ml-3 -mb-5">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        @section('js-bottom')
            <script src="https://cdn.jsdelivr.net/npm/chart.js@2.9.3/dist/Chart.min.js" defer
